...
import {Path, GetPaths, SunnycoindPathsResponse} from '../pathfind-types'
...
function parseAlternative(sourceAddress: string, destinationAddress: string,
  destinationAmount: SunnycoindAmount, alternative: any
): Path {
...
function parsePathfind(pathfindResult: SunnycoindPathsResponse): GetPaths {
