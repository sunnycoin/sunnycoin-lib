...
class SunnycoinAPI extends EventEmitter {
  _feeCushion: number
  _maxFeeSUN: string

  // New in > 0.21.0
  // non-validated ledger versions are allowed, and passed to sunnycoind as-is.
  ...
  sunToDrops = sunToDrops
  dropsToSun = dropsToSun
  iso8601ToSunnycoinTime = iso8601ToSunnycoinTime
  txFlags = txFlags
