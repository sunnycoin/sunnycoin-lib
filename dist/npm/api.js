...
class SunnycoinAPI extends events_1.EventEmitter {
    constructor(options = {}) {
        super();
        ...
        this.sunToDrops = common_1.sunToDrops;
        this.dropsToSun = common_1.dropsToSun;
        this.iso8601ToSunnycoinTime = common_1.iso8601ToSunnycoinTime;
        ...
        this._maxFeeSUN = options.maxFeeSUN || '2';
     ...
     *
     * See https://sunnycoin.com/build/sunnycoind-apis/#markers-and-pagination
     */
...
SunnycoinAPI._PRIVATE = {
    validate: common_1.validate,
    RangeSet: rangeset_1.default,
    ledgerUtils,
    schemaValidator
};
SunnycoinAPI.renameCounterpartyToIssuer = utils_1.renameCounterpartyToIssuer;
SunnycoinAPI.formatBidsAndAsks = orderbook_1.formatBidsAndAsks;
exports.SunnycoinAPI = SunnycoinAPI;
