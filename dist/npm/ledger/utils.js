...
exports.clamp = clamp;
function getSUNBalance(connection, address, ledgerVersion) {
    const request = {
        command: 'account_info',
        account: address,
        ledger_index: ledgerVersion
    };
    return connection.request(request).then(data => common.dropsToSun(data.account_data.Balance));
}
exports.getSUNBalance = getSUNBalance;
