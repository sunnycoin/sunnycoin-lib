...
// TODO: remove this function once sunnycoind provides quality directly
...
// sunnycoind 'account_offers' returns a different format for orders than 'tx'
...
function parseAccountOrder(address, order) {
    ...
    const specification = common_1.removeUndefined({
        ...
        // sunnycoind currently does not provide "expiration" in account_offers
        expirationTime: utils_1.parseTimestamp(order.expiration)
    });
    const makerExchangeRate = order.quality ?
        utils_1.adjustQualityForSUN(order.quality.toString(), takerGetsAmount.currency, takerPaysAmount.currency) :
