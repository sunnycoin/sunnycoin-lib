...
declare function getSUNBalance(connection: Connection, address: string, ledgerVersion?: number): Promise<string>;
...
/**
 *  Order two sunnycoind transactions based on their ledger_index.
 *  If two transactions took place in the same ledger, sort
 *  them based on TransactionIndex
 *  See: https://sunnycoin.com/build/transactions/
 */
...
export { getSUNBalance, ensureLedgerVersion, compareTransactions, renameCounterpartyToIssuer, renameCounterpartyToIssuerInOrder, getRecursive, hasCompleteLedgerRange, isPendingLedgerVersion, clamp, common };
