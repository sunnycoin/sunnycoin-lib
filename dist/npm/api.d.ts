...
import { Connection, errors, validate, sunToDrops, dropsToSun, iso8601ToSunnycoinTime } from './common';
...
declare class SunnycoinAPI extends EventEmitter {
    _feeCushion: number;
    _maxFeeSUN: string;
     ...
     * general use. Instead, use sunnycoind's built-in pagination and make multiple
     * requests as needed.
     */
    ...
    sunToDrops: typeof sunToDrops;
    dropsToSun: typeof dropsToSun;
    iso8601ToSunnycoinTime: typeof iso8601ToSunnycoinTime;
    txFlags: {
        Universal: {
