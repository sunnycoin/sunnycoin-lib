...
class SunnycoinAPIBroadcast extends api_1.SunnycoinAPI {
    constructor(servers, options) {
        super(options);
        this.ledgerVersion = undefined;
        const apis = servers.map(server => new api_1.SunnycoinAPI(_.assign({}, options, { server })));
        // exposed for testing
        this._apis = apis;
...
exports.SunnycoinAPIBroadcast = SunnycoinAPIBroadcast;
